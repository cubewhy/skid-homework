 ...
 */
export const normalizeFramePayload = (data) => {
 ...
 */
export const parseFramePacket = (data) => {
 ...
 */
export const decodeFramePacketToRgba = (data, targetRgba) => {
 ...
 */
export const decodeQoiToRgba = (payload, expectedWidth, expectedHeight) => {
 ...
 */
export const decodeLuma8ToRgba = (payload, width, height, targetRgba) => {
  const pixelCount = width * height;
 ...
 * @returns {Uint8ClampedArray<ArrayBuffer>}
 */
export const decodeI420ToRgba = (payload, width, height, targetRgba) => {
